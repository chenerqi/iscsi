...
pushd usr
%{__make} install DESTDIR=%{buildroot} sbindir=%{_sbindir} libdir=%{_prefix}/lib/tgt CEPH_RBD=1
...
%{_sbindir}/tgt-admin
%{_sbindir}/tgtimg
%{_prefix}/lib/tgt/backing-store/bs_rbd.so
%{_mandir}/man5/*
%{_mandir}/man8/*
%{_initrddir}/tgtd
